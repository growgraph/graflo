...
_EXPORTS: dict[str, str] = {
    ...
    "ProfileReport": "graflo.architecture.profile",
    "ProfileWaivers": "graflo.architecture.profile",
    "check_manifest": "graflo.architecture.profile",
    "check_manifest_config": "graflo.architecture.profile",
