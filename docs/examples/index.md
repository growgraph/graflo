...
13. **[Graph export and migration](example-13.md)** — Export **`GraFloOutput`** from Neo4j or ArangoDB, migrate graph→graph, or land the logical model in PostgreSQL as vertex + junction edge tables. No manifest required.