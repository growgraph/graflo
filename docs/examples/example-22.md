# Example 22 — state-core: lifting a manifest into a twin-ready schema

**Source:** [`examples/22-state-core/`](https://github.com/growgraph/graflo/tree/main/examples/22-state-core)
