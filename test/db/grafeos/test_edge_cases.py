"""Edge case and robustness tests for Grafeo connector.

This module provides a comprehensive adversarial test suite for the Grafeo
...
Security & Injection Prevention:
    - Query injection via property values, labels, and match keys
...
Run all edge case tests::
    ...
    pytest test/db/grafeos/test_edge_cases.py -v

Run specific category::

    pytest test/db/grafeos/test_edge_cases.py -k "Injection" -v
...
- test.db.grafeos.conftest : Test fixtures and configuration
"""
...
class TestPropertyKeySmuggling:
    ...
    def test_internal_property_names(self, conn_conf, test_graph_name, clean_db):
        """Try to use internal Grafeo/Neo4j property names."""
        _ = clean_db
        with ConnectionManager(connection_config=conn_conf) as db:
            internal_names = [
                "_id",
