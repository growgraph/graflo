"""Tests for Memgraph data ingestion operations.

This module validates the complete ingestion workflow using the review dataset,
including fetch operations, filtering, limiting, projections, and aggregations.
"""
